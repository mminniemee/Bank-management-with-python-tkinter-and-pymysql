...
def login2():
    ...
    lb.place(x=10, y=10)
    lb=Label(login_win, text="---ACCOUNT LOGIN---", bg="#9CBA7F", font=("Times New Roman",33),width=25)
    lb.place(x=50, y=100)

    lb1=Label(login_win, text="Enter email:", font=("Times New Roman",15), bg="#9CBA7F")
    lb1.place(x=90, y=200)

    lb2=Label(login_win, text="Enter password:", bg="#9CBA7F", font=("Times New Roman",15))
...
def registration():
    ...
    lb1=Label(rewin, text="Enter account number:", font=("Times New Roman",15), bg="#9CBA7F")
    lb1.place(x=200, y=150)

    lb2=Label(rewin, text="Enter name:", bg="#9CBA7F", font=("Times New Roman",15))
    lb2.place(x=200, y=200)

    lb3=Label(rewin, text="Enter amount:", bg="#9CBA7F", font=("Times New Roman",15))
    lb3.place(x=200, y=250)

    lb4=Label(rewin, text="Enter address:", bg="#9CBA7F", font=("Times New Roman",15))
    lb4.place(x=200, y=300)

    lb5=Label(rewin, text="Enter contact:", bg="#9CBA7F", font=("Times New Roman",15))
    lb5.place(x=200, y=350)

    lb6=Label(rewin, text="password(more than 6 words):", bg="#9CBA7F", font=("Times New Roman",15))
    lb6.place(x=200, y=400)

    lb7=Label(rewin, text="Confirm password:", bg="#9CBA7F", font=("Times New Roman",15))
    lb7.place(x=200, y=450)

    lb8=Label(rewin, text="Enter email:", bg="#9CBA7F", font=("Times New Roman",15))
...
def show_recommendations(frame, account_no):
    ...
    rec_label = Label(frame, text="Recommendations", font=("Arial", 14, "bold"), bg="#9CBA7F")
    rec_label.place(x=890, y=250)
    
    recommendations_label = Label(frame, text=recommendations_text, font=("Arial", 12), bg="#9CBA7F", wraplength=300)
...
def main_page(logged_in_acc_no, name, balance):
    ...
    lb2=Label(mwin, text=f"--------------------WELCOME BACK, {name}--------------------", bg="#9CBA7F",width=35,font=("Felix Titling",26))
    ...
    graph_frame = Frame(mwin, bd=5, bg="#9CBA7F")
    ...
    frame1=Frame(mwin,bg= "dark green", bd=10, relief="raised", width=300, height=550)
    ...
    bt=Button(frame1, text="Transfer funds within bank", bg="white", bd= 10, relief="raised", font=("Times New Roman", 15), width=20, height=2, command= internal_external)
    bt.place(x=10, y=110)
...
def transfer_funds():
    ...
    def choosebank():
        ...
        try:
            ...
            if result:
                ...
                win1.config(bg='#9CBA7F')


                lb=Label(win1, text="SELECT THE OPTION", font=("Times New Roman",30), bg="#9CBA7F")
    ...
    def transfer_bank():
        ...
        lb=Label(win2, text="Enter card number from", font=("Times New Roman",20), bg="#9CBA7F")
        lb.place(x=150, y=100)

        lb=Label(win2, text="Enter password", font=("Times New Roman",20), bg="#9CBA7F")
        lb.place(x=150, y=200)

        lb=Label(win2, text="Enter amount", font=("Times New Roman",20), bg="#9CBA7F")
        lb.place(x=150, y=300)

        lb=Label(win2, text="Enter card number to", font=("Times New Roman",20), bg="#9CBA7F")
        lb.place(x=150, y=400)

        lb=Label(win2, text="Enter isfc", font=("Times New Roman",20), bg="#9CBA7F")
        ...
        show_hide_btn2.place(x=630, y=200)
    ...
    lb=Label(win0, text="Enter email:", font=("Times New Roman",20), bg="#9CBA7F")
    lb.place(x=100, y=100)

    lb=Label(win0, text="Enter password:", font=("Times New Roman",20), bg="#9CBA7F")
...
def internal_external():
    def transfer_fundss():
        sender_acc_no = sender_acc_entry.get()
        receiver_acc_no = receiver_acc_entry.get()
        ...
        try:
            ...
            # External Transfer (Another user's account)
                ...
                conn.commit()
                messagebox.showinfo("Success", "External transfer successful!")
    ...
    root.config(bg="#9CBA7F")

    # Sender Account
    Label(root, text="Sender Account No:", font=("Times New Roman", 20), bg="#9CBA7F").place(x=100, y=70)
    sender_acc_entry = Entry(root)
    sender_acc_entry.place(x=350, y=80)

    # Receiver Account
    Label(root, text="Receiver Account No:", font=("Times New Roman", 20), bg="#9CBA7F").place(x=100, y=150)
    receiver_acc_entry = Entry(root)
    receiver_acc_entry.place(x=350, y=160)

    # Transfer Type (Internal or External) - Using Combobox
    Label(root, text="Transfer Type:", font=("Times New Roman", 20), bg="#9CBA7F").place(x=100, y=230)

    transfer_type_combo = ttk.Combobox(root, values=["Internal", "External"], state="readonly", font=("Times New Roman", 13))
    transfer_type_combo.current(0)  # Set default to "Internal"
    transfer_type_combo.place(x=350, y=235)

    # Transfer Amount
    Label(root, text="Amount:", font=("Times New Roman", 20), bg="#9CBA7F").place(x=100, y=310)
    amount_entry = Entry(root)
    amount_entry.place(x=350, y=320)

    # Submit Button
    submit_btn = Button(root, text="Transfer", bg="white", width=10, height=1, bd=10, command=transfer_fundss)
    submit_btn.place(x=250, y=390)
...
def statement():
    ...
    lb=Label(show, text="Enter account number", font=("Times New Roman",18), bg="#9CBA7F")
    lb.place(x=100, y=80)
...
def profile():
    ...
    def update_cont():
        ...
        lb=Label(ucwin, text="Enter The Following Details:", font=("Times New roman",20),bg='#9CBA7F')
        lb.place(x=70, y=40)

        lb=Label(ucwin, text="Enter Account number", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=100)


        lb=Label(ucwin, text="Enter current contact number", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=170)

        lb=Label(ucwin, text="Enter new contact number", font=("Times New roman",16),bg='#9CBA7F')
    ...
    def update_pass():
        ...
        lb=Label(upwin, text="Enter Account number", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=100)

        lb1=Label(upwin, text="Enter current password", font=("Times New roman",16),bg='#9CBA7F')
        lb1.place(x=100, y=170)

        lb=Label(upwin, text="Enter new password", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=240)

        lb=Label(upwin, text="confirm password", font=("Times New roman",16),bg='#9CBA7F')
    ...
    def update_email():
        ...
        lb=Label(uewin, text="Updating email:", font=("Times New roman",20),bg='#9CBA7F')
        lb.place(x=70, y=40)

        lb=Label(uewin, text="Enter Account number", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=100)

        lb=Label(uewin, text="Enter new email", font=("Times New roman",16),bg='#9CBA7F')
        lb.place(x=100, y=170)
    ...
    lb=Label(cpwin, text="UPDATE YOUR ACCOUNT DETAILS", font=("Times New Roman",20), bg="#9CBA7F")
    lb.place(x=60, y=50)
...
def manage_payees(account_no):
    ...
    rootpay.config(bg="#9CBA7F")
    rootpay.geometry("610x490")

    Label(rootpay, text="MANAGE YOUR PAYEES", font=("Times New Roman", 18), bg="#9CBA7F").place(x=190, y=40)

    # Payee Listbox (to display existing payees)
    Label(rootpay, text="Your Payees:", font=("Times New Roman", 15), bg="#9CBA7F").place(x=50, y=100)
    ...
    Label(rootpay, text="Payee Account No:", font=("Times New Roman", 15), bg="#9CBA7F").place(x=50, y=300)
    payee_acc_entry = Entry(rootpay)
    payee_acc_entry.place(x=250, y=300)

    Label(rootpay, text="Payee Name:", font=("Times New Roman", 15), bg="#9CBA7F").place(x=50, y=350)
...
lb.place(x=10, y=10)
lb=Label(lwin, text="---ACCOUNT LOGIN---", bg="#9CBA7F", font=("Times New Roman",33),width=25)
lb.place(x=50, y=100)

lb1=Label(lwin, text="Enter email:", font=("Times New Roman",15), bg="#9CBA7F")
lb1.place(x=130, y=200)

lb2=Label(lwin, text="Enter password:", bg="#9CBA7F", font=("Times New Roman",15))
